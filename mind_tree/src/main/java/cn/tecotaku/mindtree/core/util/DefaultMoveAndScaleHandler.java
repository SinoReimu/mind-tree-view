package cn.tecotaku.mindtree.core.util;
...
public class DefaultMoveAndScaleHandler implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    public DefaultMoveAndScaleHandler(Context context, View view) {
        this.mView = view;
